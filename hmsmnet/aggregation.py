...
class Hourglass(nn.Module):
    ...
    def __init__(self, filters, in_channels): # filters 是指 hourglass 主要输出的通道数
        ...
        # 内部卷积的通道数变化与原版TF逻辑一致
        self.conv1 = conv3d_bn(filters, 3, 1, 'same', True, in_channels=in_channels) # e.g., 32->16 or 16->16
        self.conv2 = conv3d_bn(filters, 3, 1, 'same', True, in_channels=filters)     # e.g., 16->16
